...
//  Cheatsheet
//
//  Created by Prokhor Kharchenko on 11/7/18.
...
public enum KeyboardToolbarButton: Int {
    ...
    public func createButton(target: Any?, action: Selector?) -> UIBarButtonItem {
    ...
    public static func detectType(barButton: UIBarButtonItem) -> KeyboardToolbarButton? {
